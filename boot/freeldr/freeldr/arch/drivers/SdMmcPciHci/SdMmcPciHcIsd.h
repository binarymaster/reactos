...
#include <hwdefs/Emmc.h>
#include <hwdefs/Sd.h>

#include <arch/drivers/interface/SdMmcPassThru.h>

#include "SdMmcPciHci.h"

#define SD_MMC_HC_PRIVATE_FROM_THIS(a) \
    BASE_CR(a, SD_MMC_HC_PRIVATE_DATA, PassThru)
...
typedef struct {
  ...
  EFI_SD_MMC_DEVICE                   ConnectedDevice[SD_MMC_HC_MAX_SLOT];
  PISD_DRIVER_INTERFACE               Driver[SD_MMC_HC_MAX_SLOT];
  VOID                                *DriverContext[SD_MMC_HC_MAX_SLOT];
...
typedef struct {
  ...
  EFI_SD_MMC_CALLBACK                 EventCallback;
...
#define SD_MMC_HC_TRB_FROM_THIS(a) \
    BASE_CR(a, SD_MMC_HC_TRB, TrbList)
...
SdMmcCreateTrb (
  ...
  IN EFI_SD_MMC_CALLBACK                 EventCb,
  IN VOID                                *EventCbCtx
  );
