  ...
  )
{
  ...
  Status = SdMmcPassThruPassThru (PassThru, Slot, &Packet, NULL, NULL);
  ...
  )
{
  ...
  Status = SdMmcHcUhsSignaling (PciIo, Slot, BusMode.BusTiming);
  if (EFI_ERROR (Status)) {
    return Status;
  }
  ...
  )
{
  ...
  printf("SdCardIdentification: Found a SD device at slot [%d]\n", Slot);
